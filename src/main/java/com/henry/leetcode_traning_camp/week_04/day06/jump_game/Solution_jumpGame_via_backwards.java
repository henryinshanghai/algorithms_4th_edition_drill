...
//        int[] currentSpotToItsMaxJumpDistance = {2,3,1,1,4};
        ...
        boolean canOrNot = ableToReachEnd(currentSpotToItsMaxJumpDistance);
        System.out.println("按照当前数组能够跳到数组末尾？" + canOrNot);
    }

    private static boolean ableToReachEnd(int[] currentSpotToItsMaxJumpDistance) {
