...
public class Graph_simple_drill02 {
    // 顶点数量
    private int V;
    // 边的数量
    private int E;
    ...
    // 构造器 - 初始化所有的成员变量
    public Graph_simple_drill02(int V) {
        this.V = V;
        this.E = 0;

        // 初始化图 - 每一个顶点的邻接表都初始化为空的bag对象
    ...
    // 构造函数2
    public Graph_simple_drill02(In in) {
        // 初始化顶点数量、边的数量
        this(in.readInt());
        int E = in.readInt();
    ...
    public static void main(String[] args) {
        In in = new In(args[0]);
        Graph_simple_drill02 g = new Graph_simple_drill02(in);
