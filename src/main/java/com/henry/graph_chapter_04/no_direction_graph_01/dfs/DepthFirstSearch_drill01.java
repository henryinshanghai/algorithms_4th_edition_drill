...
// 任务：遍历图中的每一个顶点、边，以实现某些更具体的作用 比如，查询从起点s到给定的顶点v 是否是
public class DepthFirstSearch_drill01 {
    ...
    // 构造器 - 完成成员变量的初始化
    public DepthFirstSearch_drill01(Graph G, int s) {
    ...
    public static void main(String[] args) {
        ...
        // 1 创建 DFS对象
        DepthFirstSearch_drill01 dfs = new DepthFirstSearch_drill01(G, s);
