...
public class CC_book_drill04 {
    ...
    // 构造器
    public CC_book_drill04(Graph G) {
    ...
    public static void main(String[] args) {
        ...
        CC_book_drill04 cc = new CC_book_drill04(graph);

        // APIs获取图的性质 - 图中有几个子图
        int groupNum = cc.groupNum();
        StdOut.println("there are " + groupNum + "connected components in G.");

        // 打印图中所有的连通分量 - 这需要准备邻接表数组
        // 手段：邻接表数组 aka Bag[]
        Bag<Integer>[] components = new Bag[groupNum];
        // 初始化components
