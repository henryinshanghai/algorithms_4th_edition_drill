 ...
 *  Compilation:  javac BinarySearchSTFromWebsite.java
 *  Execution:    java BinarySearchSTFromWebsite
 ...
 *
 *  % java BinarySearchSTFromWebsite < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
 ...
 */
public class BinarySearchSTFromWebsite<Key extends Comparable<Key>, Value> {
     ...
     */
    public BinarySearchSTFromWebsite() {
        this(INIT_CAPACITY);
    }
     ...
     */
    public BinarySearchSTFromWebsite(int capacity) {
    ...
    /**
     * Unit tests the {@code BinarySearchSTFromWebsite} data type.
     *
     * @param args the command-line arguments
     */
    public static void main(String[] args) {
        BinarySearchSTFromWebsite<String, Integer> st = new BinarySearchSTFromWebsite<String, Integer>();
