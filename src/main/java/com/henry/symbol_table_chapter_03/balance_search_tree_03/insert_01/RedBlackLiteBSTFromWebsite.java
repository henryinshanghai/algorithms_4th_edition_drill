...
/******************************************************************************
 *  Compilation:  javac RedBlackLiteBSTFromWebsite.java
 *  Execution:    java RedBlackLiteBSTFromWebsite < input.txt
 ...
 *
 *  % java RedBlackLiteBSTFromWebsite < tinyST.txt
 *  A 8
 *  C 4
 *  E 12
 *  H 5
...
public class RedBlackLiteBSTFromWebsite<Key extends Comparable<Key>, Value> {
    ...
    public static void main(String[] args) {
        ...
        RedBlackLiteBSTFromWebsite<String, Integer> st = new RedBlackLiteBSTFromWebsite<String, Integer>();
...
//        RedBlackLiteBSTFromWebsite<Integer, Integer> st2 = new RedBlackLiteBSTFromWebsite<Integer, Integer>();
//        for (int i = 0; i < n; i++) {
//            st2.put(i, i);
//            int h = st2.height();
