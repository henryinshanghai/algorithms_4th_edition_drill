...
/******************************************************************************
 *  Compilation:  javac MergeFromWebsite.java
 *  Execution:    java MergeFromWebsite < input.txt
 ...
 *
 *  % java MergeFromWebsite < tiny.txt
 *  A E E L M O P R S T X                 [ one string per line ]
 *
 *  % more words3.txt
 *  bed bug dad yes zoo ... all bad yet
 *
 *  % java MergeFromWebsite < words3.txt
 *  all bad bed bug dad ... yes yet zoo    [ one string per line ]
 *
 ******************************************************************************/

/**
 *  The {@code MergeFromWebsite} class provides static methods for sorting an
 ...
 *  @author Kevin Wayne
 */
public class MergeFromWebsite {

    // This class should not be instantiated.
    private MergeFromWebsite() { }
